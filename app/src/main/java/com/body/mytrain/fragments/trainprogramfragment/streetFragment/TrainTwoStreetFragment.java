...
public class TrainTwoStreetFragment extends BaseFragment {
    ...
    public static TrainTwoStreetFragment newInstance(int page, int diffPosition) {
        Bundle args = new Bundle();
        args.putInt(ARG_PAGE, page);
        TrainTwoStreetFragment fragment = new TrainTwoStreetFragment();
